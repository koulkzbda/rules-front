...
export let compliance1 = new Compliance(
  ...
  new Date(2020, 9, 21, 19, 0, 0),
  [
    new ComplianceRule(ESGGroup.label,
      ...
      null,
      5),
    new ComplianceRule(ESGGroup.label, ESGGroup.watchlists[1], new NumericalFieldType('MV Weight'), 'Average', '>', 'N/A', null, 10),
    new ComplianceRule(ESGGroup.label, ESGGroup.watchlists[2], new NumericalFieldType('MV Weight'), 'Average', '>', 'N/A', null, 20),
    new ComplianceRule(ESGGroup.label, ESGGroup.watchlists[3], new NumericalFieldType('MV Weight'), 'Average', '>=', 'N/A', null, 10),
    new ComplianceRule(ESGGroup.label, ESGGroup.watchlists[4], new NumericalFieldType('ESG Score'), 'Average', '<', 'N/A', 70, 65),
    new ComplianceRule(UCITSGroup.label, UCITSGroup.watchlists[0], new NumericalFieldType('MV Weight'), 'Average', '>=', 'N/A', null, 10),
    new ComplianceRule(UCITSGroup.label, UCITSGroup.watchlists[1], new NumericalFieldType('MV Weight'), 'Average', '>=', 'N/A', null, 30),
    new ComplianceRule(UCITSGroup.label, UCITSGroup.watchlists[2], new NumericalFieldType('MV Weight'), 'Average', '>=', 'N/A', 35, 40),
    new ComplianceRule(CustomGroup.label, CustomGroup.watchlists[0], new NumericalFieldType('MV Weight'), 'Average', '>=', 'N/A', 55, 60),
  ],
  1
);

export const OPERATOR_AGGREGATION = [
  'Sum',
  'Average',
  'Minimum',
  'Maximum',
